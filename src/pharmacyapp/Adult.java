...
public class Adult extends Customer {
    ...
    public Adult(Account account, int cash, int age) {
        super(account, cash, age);
    }

    public Adult(Account account, int cash, int check, int age) {
        super(account, cash, check, age);
    }

    public Adult(Account account, int cash, int check, int credit, int age) {
